...
const config: Config = {
  ...
  // Set the production url of your site here
    url: (process.env.DEPLOY_ENV === 'vercel' || process.env.VERCEL) ? 'https://physical-ai-humanoid-robotics-psi-five.vercel.app' : 'https://faizanmasood302.github.io',
  ...
  stylesheets: [
    {
      ...
      type: 'text/css',
      integrity: 'sha384-Xi8rHCmBmhbuyyhbI88391ZKP2dmfnOl4rT9ZfRI7mLTdk1wbl0tC9XR7FOLb8r3Vm',
  ...
  themeConfig: {
    ...
    // Built-in search functionality is enabled by default in Docusaurus
    docs: {
      versionPersistence: 'localStorage',
    },
    // Search bar can be added to navbar if needed
    // navbar: {
    //   hideOnScroll: false,
    // },
    footer: {
